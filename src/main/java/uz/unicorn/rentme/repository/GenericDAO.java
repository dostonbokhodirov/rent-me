...
import uz.unicorn.rentme.utils.BaseUtils;
...
public abstract class GenericDAO<T extends Auditable, C extends AbstractCriteria> {
...
//        }
    ...
    protected <G> List<G> getResults(C criteria, Query query) {
        if ((criteria.getPage() == null || criteria.getSize() == null) || (criteria.getPage() < 0 || criteria.getSize() <= 0)) {
